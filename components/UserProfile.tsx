...
const InfoRow: React.FC<{ Icon: React.FC<any>, label: string, value: string }> = memo(({ Icon, label, value }) => (
    <div className="flex items-start space-x-4 py-3">
        ...
        <div>
            ...
            <p className="text-lg font-semibold text-light-text-primary dark:text-dark-text-primary">{value}</p>
        </div>
    </div>
));
    ...
    >
        ...
        >
            ...
            <div className="p-6 divide-y divide-light-border dark:divide-dark-border">
                ...
                <InfoRow Icon={KeyIcon} label="ID de Login" value={user.loginId} />
