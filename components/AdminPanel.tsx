                ...
                <ol className="list-decimal list-inside space-y-3 text-light-text-secondary dark:text-dark-text-secondary">
                    ...
                    <li>
                        ...
                        <ul className="list-disc list-inside ml-4 mt-2 space-y-1">
                            ...
                            <li>O <strong>valor</strong> será um objeto com os dados da aluna: <code className="bg-dark-bg text-gold px-1 rounded-md text-xs">id</code> (único, minúsculo), <code className="bg-dark-bg text-gold px-1 rounded-md text-xs">name</code> e <code className="bg-dark-bg text-gold px-1 rounded-md text-xs">courseType</code>.</li>
                        </ul>
                    </li>
                     <li>
