...
export const fundamentosSection: CourseSection = {
  ...
  content: [
    ...
    { type: 'list', content: [
      ...
      '**3. Remoção (O Cuidado Final):** É a retirada completa e segura de todas as extensões, utilizando um produto específico ou manualmente. É um procedimento delicado que, quando bem executado, mostra o seu %%profissionalismo e cuidado%% com a saúde da cliente.'
    ]}
  ]
};