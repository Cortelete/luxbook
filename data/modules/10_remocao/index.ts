...
export const remocaoSection: CourseSection = {
  id: 'remocao',
  title: '9. Remoção: O Cuidado Final e a Saúde dos Cílios',
  brief: 'Preparação, técnicas de remoção e finalização.',
  content: [
    { type: 'paragraph', content: 'A remoção é um procedimento tão importante quanto a aplicação e manutenção, pois garante a %%saúde e integridade dos cílios naturais%% da cliente. Uma remoção mal feita pode danificar os fios.'},
    { type: 'subsection_title', id: 'remocao_preparacao', content: '9.1. Preparação para a Remoção Segura' },
    { type: 'list', content: [
    ...
    { type: 'list', content: [
      '**Aplicação do Removedor (Creme/Gel):** Com um microbrush, pegue uma pequena quantidade do removedor e comece aplicando na base das extensões. Deslize para cima, cobrindo toda a extensão. %%Evite contato com a pele%%.',
      '**Tempo de Ação:** Deixe o removedor agir pelo tempo indicado no rótulo do produto (geralmente de %%5 a 10 minutos%%).',
