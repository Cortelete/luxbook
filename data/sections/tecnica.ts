...
export const tecnicaSection: CourseSection = {
  ...
  content: [
    ...
    { type: 'image_carousel', content: { caption: 'Ilustração detalhada mostrando a acoplagem correta, a distância da pálpebra, e exemplos de erros comuns: muita cola, base solta, colada na pele.', images: [] } },
    { type: 'table', content: {
