...
export const mappingSection: CourseSection = {
  ...
  content: [
    ...
    { type: 'image_carousel', content: { caption: 'Ilustração clara dos 3 formatos de olho com o desenho do mapping sobre eles: Boneca, Gatinho e Esquilo, mostrando a distribuição dos tamanhos.', images: [] } },
    { type: 'list', content: [
    ...
    { type: 'list', content: [
     ...
     { type: 'image_carousel', content: { caption: 'Espaço para Prática: Desenhe aqui os 3 tipos de mapping, distribuindo os tamanhos dos fios: Boneca: Gatinho: Esquilo:', images: [] } },
  ]
};